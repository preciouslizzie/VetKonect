...
class AdsPromotionScreen extends StatefulWidget {
  final webViewController = Get.put(WebViewControllerGetX());

  AdsPromotionScreen({super.key});

  @override
  State<AdsPromotionScreen> createState() => _AdsPromotionScreenState();
}

class _AdsPromotionScreenState extends State<AdsPromotionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Ads Promotion "),
      ),
      body: Stack(
        children: [
          if (_isConnected)
